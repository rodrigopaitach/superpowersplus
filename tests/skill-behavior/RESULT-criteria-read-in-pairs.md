...
| **Rule changed since** | 2026-09-06 (35bab0b) — H1 adds nine lines to step (a) of the round-2 repair review, requiring the reviewer to identify the quantity a claim names before measuring it. The Plan Contract row about contradictory spec criteria is unchanged. This historical experiment was not re-run against the complete updated prompt; its original date and verdict remain historical. Earlier: 2026-09-04 (88d0864) changed the verification-matrix requirements and added the evidence-model marker rule without changing the contradictory-criteria row; 2026-09-03 (1850fb8) added the Previous findings line and capped Recommendations. The changes are recorded here, not treated as new measurements |
