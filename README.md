...
Every change is in [CHANGELOG.md](CHANGELOG.md); the `plus.N` entries that led to 1.0.0 are preserved in [docs/PLUS-CHANGELOG-historico.md](docs/PLUS-CHANGELOG-historico.md). Gaps deliberately left open are under [Known gaps](CHANGELOG.md#known-gaps).
