...
- **`skills/writing-plans/SKILL.md` must end at or under 500 lines** — `scripts/check-skill-size.sh:26` sets `MAX=500`, and the file stands at 486. A body over the ceiling is fixed by moving content to `references/`, never by compressing it.
